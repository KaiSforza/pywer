...
.. function:: pretty_print_search(term, stype='search', baseurl=None, ood=True, be_verbose=0, color=False, format_str=None, dbpath='/var/lib/pacman', sort_as='Name', sort_rev=False, ign=[])
...
.. function:: pretty_print_info(package, baseurl=None, ood = True, color=False, more_info=False, format_str=None, sort_as='Name', sort_rev=False, ign=[])
...
.. function:: pretty_print_updpkgs(other_repos=[], baseurl=None, pkgs=[], be_verbose=0, color=False, ign=[])

   Prints a user-readable list of updatable packages.

.. function:: download_pkgs(list_of_pkgs, dl_path, dl_verbose=0, baseurl=None, dl_force=False, ood=True, color=False, ign=[])
...
* ``ign``, used to ignore a package when printing.
